...
public class EpsSmsLog implements Serializable {
	...
	private String msisdn; // numero 
	

	@Column(name="SENDER_MODULE", length=64) // ACS 
	private String SenderModule;
	
	//@Id
	//@NotNull
	@Column(name="SMS_TEXT", length=2000, nullable = false) // text 
	private String smsText;
	
	//@NotNull
	//@Id
	@Column(name="SMS_STATUS", nullable = false)
	private Character smsStatus; //N
